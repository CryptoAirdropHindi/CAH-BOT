...
echo -e ' ╚═════╝╚═╝  ╚═╝   ╚═╝   ╚═╝        ╚═╝    ╚═════╝ ╚═╝  ╚═╝╚═╝╚═╝  ╚═╝╚═════╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝╚═════╝ ╚═╝'
echo -e ""
echo -e "\033[1;34m                 CryptoAirdropHindi \e[0m"
echo -e "Subscribe to our Telegram Channel: \e[4;35m https://t.me/Crypto_airdropHM/ \e[0m"
echo "================================================================"
echo -e "To exit the script, press \e[1;31mctrl + C\e[0m."
